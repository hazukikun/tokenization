import svgPaths from "./svg-l2m7rkm7l1";
...
export default function Component() {
  return (
    <div className="bg-[#f2f3f7] content-stretch flex flex-col gap-[12px] items-center overflow-clip relative rounded-[24px] size-full" data-name="Экран продукта">
